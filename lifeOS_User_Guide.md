...
| `lifeos recommend, r` | lifeOS will guess your capacity based on your tasks and events. |
| `lifeos degrade, d` | Lowers your capacity to the next level down. |
| `lifeos sync, y` | (Coming soon!) This will connect to your other apps, like your to-do list and calendar. |
